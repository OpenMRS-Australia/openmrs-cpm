...
public class SubmitProposal {
	...
	public ProposedConceptReviewPackageDto getProposalStatus(final ProposedConceptPackage conceptPackage) {
		...
		AdministrationService service = Context.getAdministrationService();
		HttpHeaders headers = httpHeaderFactory.create(service.getGlobalProperty(CpmConstants.SETTINGS_USER_NAME_PROPERTY), service.getGlobalProperty(CpmConstants.SETTINGS_PASSWORD_PROPERTY));
