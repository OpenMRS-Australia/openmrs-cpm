...
import org.openmrs.module.conceptreview.ProposedConceptResponseAnswer;
...
public class TestProposedConceptResponseService extends CpmBaseContextSensitive {

    private static final Log log = LogFactory.getLog(TestProposedConceptResponseService.class);
    ...
    protected ProposedConceptResponseService service = null;
    ...
    public void before() throws Exception {
        service = Context.getService(ProposedConceptResponseService.class);
